...
class Config(object):
    def __init__(self):
        ...
        self.save_net_path = "log/PAIP2020/efficientnet-b2_find_tissue/model_net_21393.pth"
        ...
        self.model_name = 'efficientnet-b2_find_tissue_test'
        self.log_dir = self.log_path + self.model_name

    def train_augmentors(self):
        shape_augs = [
            iaa.PadToFixedSize(self.data_size[0], self.data_size[1], pad_mode='reflect'),
            iaa.Affine(
