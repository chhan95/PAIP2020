...
wsi_load_dir = 'data/wsi_folder/'
xml_load_dir = 'data//xml_folder/'
...
save_dir = 'data/mask_img_l2/'
os.makedirs(save_dir, exist_ok=True)
div = 1                                   ## Level0 scale to Level2 scale
...
def save_mask(xml_fn, shape):
  ...
  save_fn = save_dir + '{}.tif'.format(wsi_id)
...
if __name__ == '__main__':
  for i, (wsi_fn, xml_fn) in enumerate(zip(wsi_fns, xml_fns)):
    ...
    shape = load_svs_shape(wsi_fn, level=0)
